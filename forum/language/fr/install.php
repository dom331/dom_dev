...
$lang = array_merge($lang, array(
	...
	'COLLIDING_USERNAMES_FOUND'	=> 'Plusieurs membres utilisent un même nom d’utilisateur sur votre ancien forum. Pour poursuivre la conversion, supprimez ou renommez les comptes listés ci-dessous afin qu’un même nom d’utilisateur ne soit pas utilisé par plusieurs membres.',
	...
	'CONVERT_SETTINGS_VERIFIED'	=> 'Les informations saisies ont été vérifiées. Pour démarrer la conversion, cliquez sur le bouton ci-dessous.',
	...
	'PCRE_UTF_SUPPORT_EXPLAIN'			=> 'phpBB <strong>ne fonctionnera pas</strong> si votre installation PHP n’est pas compilée avec la prise en charge de UTF-8 dans l’extension PCRE.',
	...
	'PHP_SETTINGS_EXPLAIN'				=> '<strong>Requis</strong> - Vous devez utiliser au moins la version 5.3.3 de PHP (PHP 7 n’est pas pris en charge) pour installer phpBB. Si <var>safe mode</var> est affiché, PHP fonctionne dans ce mode. Cela implique des limitations sur l’administration distante et des fonctionnalités similaires.',
...
$lang = array_merge($lang, array(
	...
	'CHANGE_CLEAN_NAMES'			=> 'La méthode utilisée, pour être sûr qu’un nom d’utilisateur n’est pas utilisé plusieurs fois, a été modifiée. La nouvelle méthode de comparaison a détecté que certains membres ont le même nom d’utilisateur. Avant de procéder, vous devrez supprimer ou renommer ces membres pour être sûr que chaque nom ne soit utilisé que par un seul membre.',
	...
	'DELETE_USER_REMOVE'				=> 'Supprimer le membre et ses messages',
	'DELETE_USER_RETAIN'				=> 'Supprimer le membre mais conserver ses messages',
	...
	'PACKAGE_UPDATES_TO'				=> 'Version du pack de mise à jour',
	...
	'UPDATE_INCOMPLETE'				=> 'Votre installation phpBB n’a pas été correctement mise à jour.',
	'UPDATE_INCOMPLETE_MORE'		=> 'Veuillez lire les informations ci-dessous afin de corriger cette erreur.',
	'UPDATE_INCOMPLETE_EXPLAIN'		=> '<h1>Mise à jour incomplète</h1>

		<p>Nous avons remarqué que la dernière mise à jour de votre installation de phpBB n’a pas été achevée. Accédez au script « <a href="%1$s" title="%1$s">database_update</a> » et exécutez-le. S’il est manquant, veuillez télécharger <a href="https://www.phpbb.com/downloads/" title="phpBB downloads">le pack de mise à jour</a>, transférez le répertoire « install » à la racine de votre forum (où votre fichier « config.php » est situé) et exécutez le <a href="%1$s" title="%1$s">script de mise à jour de la base de données</a>.</p>',
