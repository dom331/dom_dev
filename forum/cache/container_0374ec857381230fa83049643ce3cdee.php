...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        return $this->services['auth.provider.oauth'] = new \phpbb\auth\provider\oauth\oauth($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), 'zhpbb_oauth_tokens', 'zhpbb_oauth_accounts', $this->get('auth.provider.oauth.service_collection'), 'zhpbb_users', $this, './', 'php');
    }
    ...
    {
        return $this->services['config'] = new \phpbb\config\db($this->get('dbal.conn'), $this->get('cache.driver'), 'zhpbb_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text($this->get('dbal.conn'), 'zhpbb_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility($this->get('auth'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('user'), './', 'php', 'zhpbb_forums', 'zhpbb_posts', 'zhpbb_topics', 'zhpbb_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('zhpbb_captcha_questions', 'zhpbb_captcha_answers', 'zhpbb_qa_confirm');
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('localhost', 'root', '', 'dom_bdd', '', false, false);
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), $this->get('user'), 'zhpbb_ext', './', 'php', $this->get('cache.driver'));
    }
    ...
    {
        return $this->services['log'] = new \phpbb\log\log($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), './', 'adm/', 'php', 'zhpbb_log');
    }
    ...
    {
        return $this->services['migrator'] = new \phpbb\db\migrator($this, $this->get('config'), $this->get('dbal.conn'), $this->get('dbal.tools'), 'zhpbb_migrations', './', 'php', 'zhpbb_', $this->get('migrator.tool_collection'), $this->get('migrator.helper'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), './', 'php', 'zhpbb_modules');
    }
    ...
    {
        return new \phpbb\notification\type\admin_activate_user($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zhpbb_notification_types', 'zhpbb_notifications', 'zhpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\approve_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zhpbb_notification_types', 'zhpbb_notifications', 'zhpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\approve_topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zhpbb_notification_types', 'zhpbb_notifications', 'zhpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\bookmark($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zhpbb_notification_types', 'zhpbb_notifications', 'zhpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\disapprove_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zhpbb_notification_types', 'zhpbb_notifications', 'zhpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\disapprove_topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zhpbb_notification_types', 'zhpbb_notifications', 'zhpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\group_request($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zhpbb_notification_types', 'zhpbb_notifications', 'zhpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zhpbb_notification_types', 'zhpbb_notifications', 'zhpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\pm($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zhpbb_notification_types', 'zhpbb_notifications', 'zhpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zhpbb_notification_types', 'zhpbb_notifications', 'zhpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\post_in_queue($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zhpbb_notification_types', 'zhpbb_notifications', 'zhpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\quote($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zhpbb_notification_types', 'zhpbb_notifications', 'zhpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_pm($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zhpbb_notification_types', 'zhpbb_notifications', 'zhpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_pm_closed($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zhpbb_notification_types', 'zhpbb_notifications', 'zhpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zhpbb_notification_types', 'zhpbb_notifications', 'zhpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_post_closed($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zhpbb_notification_types', 'zhpbb_notifications', 'zhpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zhpbb_notification_types', 'zhpbb_notifications', 'zhpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\topic_in_queue($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'zhpbb_notification_types', 'zhpbb_notifications', 'zhpbb_user_notifications');
    }
    ...
    {
        return $this->services['notification_manager'] = new \phpbb\notification\manager($this->get('notification.type_collection'), $this->get('notification.method_collection'), $this, $this->get('user_loader'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('cache'), $this->get('user'), './', 'php', 'zhpbb_notification_types', 'zhpbb_notifications', 'zhpbb_user_notifications');
    }
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper($this->get('dbal.conn'), 'zhpbb_profile_fields_lang');
    }
    ...
    {
        return $this->services['profilefields.manager'] = new \phpbb\profilefields\manager($this->get('auth'), $this->get('dbal.conn'), $this->get('dispatcher'), $this->get('request'), $this->get('template'), $this->get('profilefields.type_collection'), $this->get('user'), 'zhpbb_profile_fields', 'zhpbb_profile_lang', 'zhpbb_profile_fields_data');
    }
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader($this->get('dbal.conn'), './', 'php', 'zhpbb_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            'core.root_path' => './',
            'core.php_ext' => 'php',
            'tables.auth_provider_oauth_token_storage' => 'zhpbb_oauth_tokens',
            'tables.auth_provider_oauth_account_assoc' => 'zhpbb_oauth_accounts',
            'tables.captcha_qa_questions' => 'zhpbb_captcha_questions',
            'tables.captcha_qa_answers' => 'zhpbb_captcha_answers',
            'tables.captcha_qa_confirm' => 'zhpbb_qa_confirm',
            'tables.config' => 'zhpbb_config',
            'tables.config_text' => 'zhpbb_config_text',
            'tables.ext' => 'zhpbb_ext',
            'tables.forums' => 'zhpbb_forums',
            'tables.log' => 'zhpbb_log',
            'tables.migrations' => 'zhpbb_migrations',
            'tables.modules' => 'zhpbb_modules',
            'tables.notification_types' => 'zhpbb_notification_types',
            'tables.notifications' => 'zhpbb_notifications',
            'tables.profile_fields' => 'zhpbb_profile_fields',
            'tables.profile_fields_data' => 'zhpbb_profile_fields_data',
            'tables.profile_fields_options_language' => 'zhpbb_profile_fields_lang',
            'tables.profile_fields_language' => 'zhpbb_profile_lang',
            'tables.posts' => 'zhpbb_posts',
            'tables.topics' => 'zhpbb_topics',
            'tables.user_notifications' => 'zhpbb_user_notifications',
            'tables.users' => 'zhpbb_users',
